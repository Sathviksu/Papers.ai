  ...
  const onSignUpSubmit = (values: z.infer<typeof signUpSchema>) => {
    startTransition(async () => {
      try {
        ...
        await createUserProfile(userCredential.user, firestore, { name: `${values.firstName} ${values.lastName}` });
        toast({
  ...
  const SignUpForm = (
    <div className="w-full max-w-sm">
        ...
        <Button variant="outline" className="w-full" onClick={handleGoogleLogin} disabled={isPending}>
            <svg className="mr-2 h-4 w-4" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512"><path fill="currentColor" d="M488 261.8C488 403.3 381.5 512 244 512 109.8 512 0 402.2 0 256S109.8 0 244 0c73 0 135.3 29.7 181.4 78.6l-65.2 65.2c-22.6-21.5-55.2-34.6-96.2-34.6-73.3 0-133.7 60.4-133.7 134.8s60.4 134.8 133.7 134.8c76.9 0 111.8-32.8 116-77.8H244V261.8h244z"></path></svg>
       ...
       <div className="relative hidden h-full flex-col p-10 text-foreground lg:flex">
        <div className="absolute inset-0 bg-[#1F1926] -z-10" />
         <div className="absolute inset-5">
            <Image
                src={loginBg?.imageUrl || "https://images.pexels.com/photos/6306917/pexels-photo-6306917.jpeg"}
                alt="Desert at night"
                fill
        ...
        <div className="relative z-20 flex items-center text-lg font-medium">
            <Link href="/" className="flex items-center gap-2 group">
              <Logo />
              <span className="font-semibold font-headline">ResearchMind AI</span>
            </Link>
        </div>
