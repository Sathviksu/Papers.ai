...
export function UploadPaperDialog({ children }: { children: React.ReactNode }) {
    ...
    if (file) {
      ...
      reader.onload = (e) => {
        ...
        toast({
          ...
          description: 'The paper text has been populated from the uploaded file.',
        });
      };
      reader.onerror = () => {
        toast({
    ...
    <Dialog open={open} onOpenChange={(isOpen) => {
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Enter the details of your paper below. You can either paste the text directly or upload a file.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g., A. Vaswani, N. Shazeer" {...field} />
                  </FormControl>
                   ...
                   <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                    ...
                    <TabsContent value="upload" className="mt-2">
                      ...
                      <FormDescription className="pt-2">
                        Upload a text file (.txt, .md). The content will be loaded into the 'Paste Text' tab.
                      </FormDescription>
                    </TabsContent>
                  </Tabs>
                  <FormMessage />
