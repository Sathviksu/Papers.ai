...
const SummaryView = dynamic(() =>
  import('./summary-view').then((mod) => mod.SummaryView)
);
const InsightsView = dynamic(() =>
  import('./insights-view').then((mod) => mod.InsightsView)
);
...
export function PaperView({ initialData }) {
