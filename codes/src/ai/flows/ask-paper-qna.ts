...
export type AskPaperQnAInput = z.infer<typeof AskPaperQnAInputSchema>;
...
export type AskPaperQnAOutput = z.infer<typeof AskPaperQnAOutputSchema>;
 ...
 */
export async function askPaperQnA(input: AskPaperQnAInput): Promise<AskPaperQnAOutput> {
